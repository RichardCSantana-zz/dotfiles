...
export ZSH=/home/richardsantana/.oh-my-zsh
...
plugins=(git docker springboot debian jump)

# User configuration

#correção do bug que impedia execução do spring
...
[[ -s "/home/richardsantana/.gvm/bin/gvm-init.sh" ]] && source "/home/richardsantana/.gvm/bin/gvm-init.sh"
